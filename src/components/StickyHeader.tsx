...
export const StickyHeader = () => {
  ...
  useEffect(() => {
    // Set webinar date to Sep 20, 2025
    const webinarDate = new Date('2025-09-20T00:00:00');
    
    // For the discount timer, we'll use 24 hours from now
      ...
      <div className="container mx-auto px-4 py-2 flex flex-col sm:flex-row items-center justify-between gap-2 text-sm">
        ...
        {isDiscountActive ? (
          <div className="flex items-center gap-2">
            <span className="font-medium">₹99 Offer Ends In:</span>
        ...
        <div className="flex items-center gap-2 text-center sm:text-right">
          ...
          <span className="font-semibold">Only 50 Seats Left!</span>
        </div>
      </div>
    </div>
  );
